...
/**
 * Generated class for the TopMenuLegacy component.
 *
 * See https://angular.io/api/core/Component for more info on Angular
 * Components.
 */
@Component({
  selector: 'top-menu-legacy',
  templateUrl: 'top-menu-legacy.html',
  styleUrls: ['top-menu-legacy.scss']
})
export class TopMenuLegacyComponent {
